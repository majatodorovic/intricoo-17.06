...
import { useAddReplayOnReviewMark } from "@/hooks/productReviews.hooks";
import formFields from "./jsonData/replyOnProductFormFields";

/**
 * Component for submitting a reply to a product review mark.
 *
 ...
 */
const ReplyOnProductReviewMarkForm = ({ id, setActiveReply, activeReply }) => {
  ...
  const { mutate: addReplayOnReviewMark, isPending } =
    useAddReplayOnReviewMark();
...
export default ReplyOnProductReviewMarkForm;
